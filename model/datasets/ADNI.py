...
class train_data_flow(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_subject = nib.load(self.image_path + "c1"+ self.train_sub_idx[idx] + ".nii").get_data()
